...
describe('calculator functionality', function() {
  ...
  it('should update the display with result of function', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should be able to handle big numbers', function(){
    ...
    element(by.css('#number9')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('8100000')
  })


  //at the moment a number by zero equals infinity
  it('a number divided by zero should display not a number', function(){
    running_total = element(by.css('#running_total'))
